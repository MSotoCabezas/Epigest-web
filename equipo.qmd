...
<p class="member-inst">Tecnóloga Médica</p>
</div>
...
<p class="member-inst">Ingeniero</p>
</div>
...
<p class="member-inst">Ingeniero en Estadística</p>
...
<h3 class="member-name">Rodrigo Torres </h3>
<p class="member-inst">Estudiante Técnologia Medica</p>
</div>

<div class="team-card">
<img src="images/equipo/camila_fuentes.png" alt="Camila Fuentes">
<h3 class="member-name">Camila Fuentes</h3>
<p class="member-inst">Estudiante Magister</p>
</div>
...
<p class="member-inst">Estudiante Doctorado</p>
...
<p class="member-inst">Estadística</p>
<a href="https://cl.linkedin.com/in/mar%C3%ADa-gloria-icaza-noguera-76066b24" class="profile-btn" target="_blank">LinkedIn</a>
</div>

<div class="team-card">
<img src="images/equipo/macarena_said.png" alt="Macarena Said">
<h3 class="member-name">Macarena Said</h3>
<p class="member-inst">Enfermería</p>
</div>

<div class="team-card">
<img src="images/equipo/andrea_leiton.png" alt="Andrea Leiton">
<h3 class="member-name">Andrea Leiton</h3>
<p class="member-inst">Kinesiología</p>
</div>

<div class="team-card">
<img src="images/equipo/scarlett_jimenéz.png" alt="Scarlett Jiménez">
<h3 class="member-name">Scarlett Jiménez</h3>
<p class="member-inst">Kinesiología</p>
</div>

<div class="team-card">
<img src="images/equipo/paula_contreras.png" alt="Paula Contreras">
<h3 class="member-name">Paula Contreras</h3>
<p class="member-inst">Nutrición y Dietética</p>
</div>

<div class="team-card">
<img src="images/equipo/maria_ines_R.png" alt="María Inés Ramirez">
<h3 class="member-name">María Inés Ramirez</h3>
<p class="member-inst">Enfermería</p>
</div>

<div class="team-card">
<img src="images/equipo/julieta_navea.png" alt="Julieta Navea">
<h3 class="member-name">Julieta Navea</h3>
<p class="member-inst">Enfermería</p>
</div>

<div class="team-card">
<img src="images/equipo/marcela_marín.png" alt="Marcela Marín">
<h3 class="member-name">Marcela Marín</h3>
<p class="member-inst">Tecnología Médica</p>
</div>

<div class="team-card">
<img src="images/equipo/sergio_oróstica.png" alt="Sergio Oróstica">
<h3 class="member-name">Sergio Oróstica</h3>
<p class="member-inst">Enfermería</p>
</div>

<div class="team-card">
<img src="images/equipo/estela_blanco.png" alt="Estela Blanco">
<h3 class="member-name">Estela Blanco, PhD</h3>
<p class="member-inst">Epidemióloga</p>
<a href="https://www.linkedin.com/in/estela-blanco-07b10a6a/?originalSubdomain=cl" class="profile-btn" target="_blank">LinkedIn</a>
</div>

<div class="team-card">
<img src="images/equipo/pablo_ruiz.png" alt="Pablo Ruiz">
<h3 class="member-name">Pablo Ruiz,PhD</h3>
<p class="member-inst">Bioquímico</p>
</div>
...
<p class="member-inst">Bioinformático</p>
<a href="https://cl.linkedin.com/in/gaboslab" class="profile-btn" target="_blank">LinkedIn</a>
</div>

<div class="team-card">
<img src="images/equipo/felipe_osorio.png" alt="Felipe Osorio">
<h3 class="member-name">Felipe Osorio</h3>
<p class="member-inst">Estudiante de Ingeniería Civil Ambiental </p>
</div>
...
<div class="team-card">
<img src="images/equipo/lucas_elgueta.png" alt="Lucas Elgueta">
<h3 class="member-name">Lucas Elgueta</h3>
<p class="member-inst">Estudiante de Ingeniería en Biomedicina </p>
</div>


<div class="team-card">
<img src="images/equipo/jorge_morales.png" alt="Jorge Morales">
<h3 class="member-name">Jorge Morales, PhD</h3>
<p class="member-inst">Ingeniero </p>
</div>

<div class="team-card">
<img src="images/equipo/miguel_retamal.png" alt="Miguel Retamal">
<h3 class="member-name">Miguel Retamal</h3>
<p class="member-inst">Estudiante Ingeniería Civil Electrónica </p>
</div>

<div class="team-card">
<img src="images/equipo/bruno_meza.png" alt="Bruno Meza">
<h3 class="member-name">Bruno Meza</h3>
<p class="member-inst">Estudiante Ingeniería Civil Electrónica </p>
</div>

<div class="team-card">
<img src="images/equipo/sebastian_diez.png" alt="Sebastián Diez">
<h3 class="member-name">Sebastián Diez, PhD</h3>
<p class="member-inst">Ingeniero Químico </p>
</div>


<div class="team-card">
<img src="images/equipo/camilo_rodriguez.png" alt="Camilo Rodríguez">
<h3 class="member-name">Camilo Rodríguez</h3>
<p class="member-inst">Ingeniero en Bioquimica </p>
</div>
